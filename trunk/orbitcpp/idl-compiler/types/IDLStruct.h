...
class IDLStructInhibited : public IDLInhibited<IDLStructBase> {
public:
	IDLStructInhibited(IDL_tree s) : IDLInhibited<IDLStructBase>(s) { }
	bool is_fixed () const { ORBITCPP_NYI("IDLStructInhibited::is_fixed"); }
	// bool conversion_required () const {  ORBITCPP_NYI("IDLStructInhibited::conversion_required"); }
};

class IDLStruct :
	public IDLCompound,
	public IDLStructBase,
	public IDLIdentified
{
public:
	IDLStruct(IDL_tree      node);
	bool is_fixed () const;
