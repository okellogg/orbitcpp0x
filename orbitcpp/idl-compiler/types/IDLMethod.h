...
class IDLMethod : public virtual IDLNotAType {
protected:
	IDLInterfaceRight &parent_interface;

public:
	IDLMethod (IDLInterfaceRight &parent_interface);
	virtual ~IDLMethod () {};
	...
	typedef vector<IDLThrowable *> ExceptionList;
	...
	string stub_decl_impl   (const IDLInterfaceRight &iface) const;
...
#endif //ORBITCPP_IDLCOMPILER_IDLMETHOD
