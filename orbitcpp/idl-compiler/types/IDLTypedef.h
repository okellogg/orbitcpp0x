...
public:
	...
	void create_union_accessors(IDLUnion const& un, IDLCaseStmt const& case_stmt, std::ostream& header, Indent indent, std::ostream& module, Indent mod_indent) const
	{
		m_alias->create_union_accessors(un, case_stmt, header, indent, module, mod_indent);
	}
};
